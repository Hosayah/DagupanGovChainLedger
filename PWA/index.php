...
<html lang="en" data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" dir="ltr" data-pc-theme="light">
  ...
  <nav class="bg-white shadow-md fixed top-0 left-0 right-0 z-50">
    <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
      ...
      <div class="space-x-6">
        ...
        <a href="#reports" class="hover:text-green-600">Reports</a>
        <a href="#feedback" class="hover:text-green-600">Feedback</a>
        <a href="./dist/auth/login.php" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">Login</a>
        <a href="./dist/auth/registration.php" class="border border-green-600 text-green-600 px-4 py-2 rounded-md hover:bg-green-100">Register</a>
      </div>
    </div>
  </nav>
  ...
  <section class="mt-24 text-center px-6 py-20 bg-gradient-to-b from-green-50 to-white">
    ...
    <div class="space-x-4">
      <a href="./src/pages/Auth/login.php" class="bg-green-600 text-white px-6 py-3 rounded-md hover:bg-green-700">View Reports</a>
      <a href="./src/pages/Auth/registration.php" class="border border-green-600 text-green-600 px-6 py-3 rounded-md hover:bg-green-100">Join as Partner</a>
    </div>
  </section>
