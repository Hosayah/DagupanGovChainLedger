          ...
          <div class="card">
            ...
            <div class="card-body">
              <form class="form-horizontal"> <!-- Form elements -->
                ...
                <div class="mb-3">
                  <label for="floatingInput2" class="form-label">Input 3<span style="color: red; font-weight: bold;">*</span></label>
                  <input type="text" class="form-control" id="floatingInput2" placeholder="Input 3" />
                </div>
                <div class="mb-4">
                  <label for="floatingInput3" class="form-label">Input 4<span style="color: red; font-weight: bold;">*</span></label>
