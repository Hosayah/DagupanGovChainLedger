       ...
       <ul class="pc-navbar">
         ...
         <li class="pc-item pc-hasmenu">
           <a href="#!" class="pc-link"><span class="pc-micon"> <i data-feather="user-minus"></i> </span><span
               class="pc-mtext">Remove Account</span><span class="pc-arrow"><i class="ti ti-chevron-right"></i></span></a>
           <ul class="pc-submenu">
             <li class="pc-item"><a class="pc-link" href="../admin/rejected-accounts.php">Rejected Accounts</a></li>
             <li class="pc-item"><a class="pc-link" href="../admin/remove-admins.php">Remove Admins</a></li>
           </ul>
         </li>
