...
<head>
  <title>Remove Rejected Accounts</title>
    <meta charset="utf-8" />
              ...
              <form class="form-horizontal" method="POST"> <!-- Form elements -->
                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php if ($rejectedUsers->num_rows > 0): ?>
                      <?php while ($row = $rejectedUsers->fetch_assoc()): ?>
                        <tr>
                          <td>
                          ...
                          <td>
                            <a href="./controller/delete-user.php?id=<?= $row['user_id'] ?>&action=delete" 
