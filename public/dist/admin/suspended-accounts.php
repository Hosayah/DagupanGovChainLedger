<?php
  ...
  $suspendedUsers = $dao->getUsersByStatusWithSearch('suspended',5, $limit, $search_term);
?>
<!doctype html>
      ...
      <div class="page-header">
        <div class="page-block">
          <div class="page-header-title">
            <h5 class="mb-0 font-medium">Suspended Accounts</h5>
          </div>
          <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="../admin/dashboard.php">Home</a></li>
            <li class="breadcrumb-item" aria-current="page">Suspended-Accounts</li>
          </ul>
        </div>
      </div>
      <!-- [ breadcrumb ] end -->
              ...
              <form class="form-horizontal" method="POST"> <!-- Form elements -->
                <div class="table-responsive">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php if ($suspendedUsers->num_rows > 0): ?>
                      <?php while ($row = $suspendedUsers->fetch_assoc()): ?>
                        <tr>
                          <td>
                          ...
                          <td>
                            <a href="./controller/update-status.php?id=<?= $row['user_id'] ?>&action=unsuspend" 
