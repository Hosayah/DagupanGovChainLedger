   ...
   <div class="navbar-wrapper">
    <br>
     <div class="m-header flex items-center justify-center py-4 px-6 h-header-height mb-2">
       <a href="../auditor/dashboard.php" class="b-brand flex items-center justify-center">
     ...
     <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
       <div class="shrink-0 flex items-center justify-left mb-5">&nbsp;&nbsp;&nbsp;&nbsp;
         <h5 class="text-center font-medium text-[15px] flex items-center gap-2">
       ...
       <ul class="pc-navbar">
         ...
         <li class="pc-item"> <!-- Dashboard menu -->
           <a href="../auditor/dashboard.php" class="pc-link">
         ...
         <li class="pc-item"> <!-- Menu 01 -->
           <a href="../auditor/view-projects.php" class="pc-link">
         ...
         <li class="pc-item pc-hasmenu"> <!-- Menu 02 -->
           <a href="../auditor/view-records.php" class="pc-link">
             <span class="pc-micon"> <i class="ph ph-receipt"></i></span>
             <span class="pc-mtext">View Records</span>
           </a>
         </li>
         <li class="pc-item pc-hasmenu"> <!-- Menu 03 -->
           <a href="../auditor/view-audits.php" class="pc-link">
