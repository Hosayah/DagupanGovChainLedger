   ...
   <div class="navbar-wrapper">
    <br>
     <div class="m-header flex items-center justify-center py-4 px-6 h-header-height mb-2">
       <a href="../citizen/dashboard.php" class="b-brand flex items-center justify-center">
     ...
     <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
       ...
       <ul class="pc-navbar">
         ...
         <li class="pc-item"> <!-- Dashboard menu -->
           <a href="../citizen/dashboard.php" class="pc-link">
         ...
         <li class="pc-item"> <!-- Menu 01 -->
           <a href="../citizen/view-projects.php" class="pc-link">
