            ...
            <div class="card-body">
              <form class="form-horizontal" method="POST" enctype="multipart/form-data"> <!-- Form elements -->
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="title" id="floatingInput" placeholder="E.g Flood Control Audit" value="<?= htmlspecialchars($result['title'])?>" required/>
                </div>
                <div class="mb-4">
                  <label for="floatingInput1" class="form-label">Summary:</label>
                  <textarea name="summary" class="form-control" id="description" value="<?= htmlspecialchars($result['summary'])?>" required placeholder="Enter Audit details"><?= htmlspecialchars($result['summary'])?></textarea>
                </div>
               <hr>
               <br>
                <div class="flex mt-1 justify-between items-center flex-wrap">
                  <div class="form-control border-0">
                    <button type="submit" id="submitBtn" class="form-control bg-success-700 text-white mx-auto shadow-2xl">Save</button>
                    <?php if (!empty($msg)): ?>
          ...
          <div class="card">
            ...
            <div class="card-body pc-component break-all whitespace-normal">
              <dl class="grid grid-cols-12 gap-6">
                ...
                <dd class="col-span-12 sm:col-span-9 min-w-0 max-w-[16rem] break-all whitespace-normal"><textarea class="w-full shadow-none border-0" style="resize: none;" readonly><?= htmlspecialchars($result['document_hash'])?> </textarea><a class="text-blue-500" target="_blank" href="<?= htmlspecialchars($link)?>">Click here to view document </a></dd>
                <dt class="col-span-12 sm:col-span-3 font-semibold">Blockchain TX:</dt>
                <dd class="col-span-12 sm:col-span-9 min-w-0 max-w-[16rem] break-all whitespace-normal"><textarea class="w-full shadow-none border-0" style="resize: none;" readonly><?= htmlspecialchars($result['tx_hash'])?></textarea></dd>
