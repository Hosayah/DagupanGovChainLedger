          ...
          <div class="card">
            ...
            <div class="card-body pc-component break-all whitespace-normal">
              <dl class="grid grid-cols-12 gap-6">
                ...
                <dd class="col-span-12 sm:col-span-9 min-w-0 max-w-[16rem] break-all whitespace-normal"><textarea class="w-full shadow-none border-0" style="resize: none;" readonly><?= htmlspecialchars($result['description'])?> </textarea></dd>
                <dt class="col-span-12 sm:col-span-3 font-semibold">Document Path:</dt>
                <dd class="col-span-12 sm:col-span-9 min-w-0 max-w-[16rem] break-all whitespace-normal"><textarea class="w-full shadow-none border-0" style="resize: none;" readonly><?= htmlspecialchars($result['document_path'])?> </textarea><a class="text-blue-500" target="_blank" href="<?= htmlspecialchars($link)?>">Click here to view document </a></dd>
          ...
          <div class="card">
            ...
            <div class="card-body pc-component break-all whitespace-normal">
              <dl class="grid grid-cols-12 gap-6">
                ...
                <dd class="col-span-12 sm:col-span-9 min-w-0 max-w-[16rem] break-all whitespace-normal"><textarea class="w-full shadow-none border-0" style="resize: none;" readonly><?= htmlspecialchars($record['document_hash'])?> </textarea></dd>
